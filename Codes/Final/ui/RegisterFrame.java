...
public class RegisterFrame extends JFrame {
    ...
    public void fillRegistrationForm(Student studentData) {
        ...
        idCardField.setText(studentData.getIdCardNumber());
        addressField.setText(studentData.getAddress());
        phoneField.setText(studentData.getPhone());
        emailField.setText(studentData.getEmail());
        usernameField.setText(studentData.getUsername());
        passwordField.setText(studentData.getPassword());
        registrationNumberField.setText(studentData.getRegistrationNumber());
        amkaField.setText(studentData.getAmka());
        departmentField.setText(studentData.getDepartment());
        institutionalEmailField.setText(studentData.getInstitutionalEmail());
        studyLevelBox.setSelectedItem(studentData.getStudyLevel());
    }
    ...
    public void clickSubmitRegistrationButton() {
        ...
        if (result.isValid()) {
            ...
            } else if (errors.contains("όρους")) {
                showTermsNotAcceptedError();
            } else if (errors.contains("μέγεθος")) {
                showInvalidFileSizeError();
            } else if (errors.contains("τύπος")) {
                showInvalidFileTypeError();
            } else {
